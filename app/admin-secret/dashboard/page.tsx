          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto space-y-4">
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full p-3 border border-slate-300 rounded-lg text-slate-800" rows={2}
              />
            </div>
              ...
              {editingQuestion.options.map((opt: any, idx: number) => (
                <div key={opt.id}>
                  ...
                  <input 
                    ...
                    className="w-full p-2 border border-slate-300 rounded-lg text-slate-800 text-sm"
                  />
                </div>
              ))}
            </div>
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full p-3 border border-slate-300 rounded-lg text-slate-800" rows={3}
              />
            </div>
